...
from apps.endpoints.models import ABTest, Endpoint
from apps.endpoints.serializers import ABTestSerializer, EndpointSerializer
...
class PredictView(views.APIView):
  def post(self, request, endpoint_name, format=None):
    ...
    algorithm_status = self.request.query_params.get("status", "develop")
